class Player:
    ...
    BASE_RECOVERY_PER_SECOND = 0.004
    CARDIO_RECOVERY_BONUS_PER_LEVEL = 0.006
    BASE_CLICK_HEART_GAIN = 0.04
    INSULATION_REDUCTION_PER_LEVEL = 0.004
    MIN_CLICK_HEART_GAIN = 0.015
